...
CREATE TABLE IF NOT EXISTS `vehicles` (
	...
	`transmission` TINYINT(4) NOT NULL DEFAULT '0',
	`brakes` TINYINT(4) NOT NULL DEFAULT '0',
	`springs` TINYINT(4) NOT NULL DEFAULT '0',
	`foil` TINYINT(4) NOT NULL DEFAULT '0',
	`tuevinfo` TEXT NULL DEFAULT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`tuevchecker` TEXT NULL DEFAULT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`tuevactive` TINYINT(4) NULL DEFAULT '0',
	`tuevdate` TIMESTAMP NULL DEFAULT NULL,
